...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play.setOnClickListener(f -> {
            playVideo();
        });

        Button moveToQuiz = findViewById(R.id.moveToQuiz);

        moveToQuiz.setOnClickListener(v -> {
    ...
    public void playVideo() {
        ...
        String path = "android.resource://com.example.touristapp/"+R.raw.tristate;
